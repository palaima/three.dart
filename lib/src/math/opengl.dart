...
void setViewMatrix(Matrix4 viewMatrix, Vector3 cameraPosition,
  ...
  var rotatedEyeX = -_x.dot(cameraPosition);
  var rotatedEyeY = -_y.dot(cameraPosition);
  var rotatedEyeZ = -_z.dot(cameraPosition);

  var xStorage = _x._storage;
  var yStorage = _y._storage;
  var zStorage = _z._storage;
