...
class Vector3 implements Vector {
  ...
  Vector3.fromBuffer(ByteBuffer buffer, int offset)
      : storage = new Float32List.view(buffer, offset, 3);
  ...
  Vector3 operator -(Vector3 other) => new Vector3(
  ...
  Vector3 postmultiply(Matrix3 arg) {
    ...
    double v2 = storage[2];
    storage[0] =
        v0 * arg.storage[0] + v1 * arg.storage[1] + v2 * arg.storage[2];
    storage[1] =
        v0 * arg.storage[3] + v1 * arg.storage[4] + v2 * arg.storage[5];
    storage[2] =
        v0 * arg.storage[6] + v1 * arg.storage[7] + v2 * arg.storage[8];
  ...
  Vector3 applyProjection(Matrix4 arg) {
    ...
    double d = 1.0 /
        (arg.storage[3] * _x +
            ...
            arg.storage[11] * _z +
            arg.storage[15]);
    storage[0] = (arg.storage[0] * _x +
            arg.storage[4] * _y +
            arg.storage[8] * _z +
            arg.storage[12]) *
        d;
    storage[1] = (arg.storage[1] * _x +
            arg.storage[5] * _y +
            arg.storage[9] * _z +
            arg.storage[13]) *
        d;
    storage[2] = (arg.storage[2] * _x +
            arg.storage[6] * _y +
            arg.storage[10] * _z +
            arg.storage[14]) *
        d;
