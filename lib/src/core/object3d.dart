...
class Object3D {
  ...
  Object3D() {
    rotation.onChange.listen((_) => quaternion.setFromEuler(rotation, update: false));
    quaternion.onChange.listen((_) => rotation.setFromQuaternion(quaternion, update: false));
  }
