...
class MeshLambertMaterial extends Material implements Lighting, Mapping, Morphing, Wireframe {
  ...
  // Not used
  var aoMap, normalScale, normalMap, bumpMap, bumpScale, lightMap, specular;
