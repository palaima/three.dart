...
void init() {
  ...
  for (var i = 0; i < geometry.faces.length; i++) {
    ...
    for (var j = 0; j < 3; j++) {
      ...
      f.vertexColors.add(new Color.fromHSL((p.y / radius + 1) / 2, 1.0, 0.5));
      f2.vertexColors.add(new Color.fromHSL(0.0, (p.y / radius + 1) / 2, 0.5));
      f3.vertexColors.add(new Color.fromHSL(0.125 * vertexIndex / geometry.vertices.length, 1.0, 0.5));
    }
  }
