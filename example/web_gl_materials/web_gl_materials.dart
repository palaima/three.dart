...
render() {
  ...
  materials[materials.length - 3].emissive.setHSL(0.54, 1.0, 0.35 * (0.5 + 0.5 * Math.sin(35 * timer)));
  materials[materials.length - 4].emissive.setHSL(0.04, 1.0, 0.35 * (0.5 + 0.5 * Math.cos(35 * timer)));
